...
CREATE OR REPLACE FUNCTION demesne.note_acl_grants(p_member_id text, p_note_id text, p_access text)
RETURNS boolean
LANGUAGE sql
STABLE
SECURITY DEFINER
